...
| `image` | string | ❌ | Base64 da imagem |
| `status` | string | ✅ | `IN_PROGRESS` \| `COMPLETED` \| `OPEN_FOR_APPLICATIONS` |
...
**Response `200 OK`:** Projeto atualizado com `teamMembers`.
...
**Response `200 OK`:** Objeto do work atualizado.
...
> Mensagens ordenadas da mais antiga à mais nova. Somente participantes têm acesso.
